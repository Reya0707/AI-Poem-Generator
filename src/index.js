...
function generatePoem(event) {
  ...
  let context =
    "You are an AI Poet that loves to tell short poems. The poem must be provided in HTML format with 7 lines only. Make sure the follow the user instructions. Example: <p>this is a poem</p>.";
